...
public abstract class Coder {
	 ...
	 * @throws Exception
	 */
	protected static byte[] encryptMD5(byte[] data) {
		MessageDigest md5;
		try {
	 ...
	 * @throws Exception
	 */
	protected static byte[] encryptSHA(byte[] data) throws Exception {
	 ...
	 * @throws Exception
	 */
	protected static byte[] encryptHMAC(byte[] data, String key)
			throws Exception {
